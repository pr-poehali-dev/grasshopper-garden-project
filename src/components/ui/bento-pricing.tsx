  ...
  return (
    <div className="grid grid-cols-1 gap-1.5 md:grid-cols-2 lg:grid-cols-8">
      ...
      >
        ...
        <div className="flex flex-col p-3 lg:flex-row">
          <div className="pb-2 lg:w-[30%]">
            ...
            <span className="text-gray-300 text-xs font-open-sans-custom">/мероприятие</span>
          </div>
          <ul className="text-gray-300 grid gap-2 text-xs lg:w-[70%] font-open-sans-custom">
            {[
              "Аренда всего теплохода на 3–6 часов",
              "Банкетное меню и безлимитный бар",
              "Декор и музыкальное сопровождение",
              "Индивидуальный менеджер под ваш праздник",
            ].map((f, i) => (
              <li key={i} className="flex items-center gap-2">
                <Check className="w-[1.05rem] h-[1.05rem] text-white flex-shrink-0" strokeWidth={3} />
      ...
      <PricingCard
        ...
        priceSuffix="/чел"
        features={[
          "Речная прогулка 2 часа",
          "Ужин в ресторане на борту",
          "Живая музыка",
          "Панорамный вид на Краснодар",
        ]}
      ...
      <PricingCard
        titleBadge="ДЕЛОВАЯ ВСТРЕЧА"
        priceLabel="от 25 000 ₽"
        priceSuffix="/аренда"
        features={[
          "VIP-зал для переговоров на 10–20 человек",
          "Фуршет и напитки включены",
          "Маршрут и время по договорённости",
        ]}
      ...
      <PricingCard
        titleBadge="РОМАНТИКА"
        priceLabel="от 15 000 ₽"
        priceSuffix="/пара"
        features={["Прогулка 3 часа для двоих", "Ужин при свечах на палубе", "Декор и цветы включены"]}
        className="lg:col-span-4"
        cta="Забронировать"
      />

      <PricingCard
        titleBadge="ИНДИВИДУАЛЬНЫЙ ПАКЕТ"
        priceLabel="По запросу"
        priceSuffix=""
        features={[
          "Эксклюзивная аренда теплохода",
          "Любой маршрут и формат",
          "Полный каtering и шоу-программа",
