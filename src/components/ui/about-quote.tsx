        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы верим, что лучший отдых — это тот, что остаётся в памяти навсегда. Наш теплоход на реке Кубань — это не просто прогулка, это целый мир впечатлений: плавный ход воды, ветер с реки и панорама Краснодара с необычного ракурса.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Влюблённые пары, деловые партнёры, большие компании — мы создаём событие под каждого гостя. Изысканная кухня на борту, живая атмосфера и безупречный сервис делают каждый выход на воду по-настоящему особенным.
            </p>
          </div>
        </div>
      </div>
